            ...
            <div className="cards-container">
                ...
                >
                    <div className="icon-box">
                        <svg width="70px" height="570px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490 490" style={{ enableBackground: 'new 0 0 490 490' }} xmlSpace="preserve" className="card-icon">
                            <g>
                                <g>
                ...
                >
                    <div className="icon-box">
                        <svg width="70px" height="150px" viewBox="0 -0.5 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" className="si-glyph si-glyph-house card-icon">
                ...
                >
                    <div className="icon-box">
                        <svg width="70px" height="58px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve" className="card-icon">
